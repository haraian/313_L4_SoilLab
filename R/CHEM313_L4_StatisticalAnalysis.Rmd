...
Cr_site <- Cr_site_avg %>% mutate(perc_difference = ICPMSavg - AAavg/((ICPMSavg+AAavg)/2))
Cr_site
...
ICPMS_avg
write.csv(ICPMS_avg, file = "ICPMS.csv", row.names = FALSE)
```
...
ttestunpaired("B") #0.4453 df=4 ttb=2.776
...
ttestunpaired("QC") #-2.1954 df=11 ttb=2.201 significant

t <- c(1.9841, 0.4435, 4.3031, 7.7403, 4.8498, 2.6169, 2.1954)
