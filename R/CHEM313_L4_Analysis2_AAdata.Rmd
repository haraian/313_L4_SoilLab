...
conc_blanked <- AA_forblank$conc_dil - MB_conc
conc_blanked_error <- sqrt((AA_forblank$conc_dil_error)^2 + (MB_conc_error)^2)
AA_blank <- AA_forblank %>% mutate(conc_blanked, conc_blanked_error)

AA_blank

rm(list = ls()[!ls() %in% c("AA", "AA_blank", "AA_cal")])
```
